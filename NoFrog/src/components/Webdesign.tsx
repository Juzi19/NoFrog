  ...
  return (
    ...
    <div id='bodywebdesign'>
        ...
        <section id='webdesigntext1'>
            ...
            <img src="/assets/picture_1.webp" alt="Glühbirne_aus" />
        </section>
        <section id='webdesigntext2'>
        <img src="/assets/keyboard.webp" alt="Keyboard" />
        ...
        <section id='webdesigntext3'>
            ...
            <img src="/assets/succes.webp" alt="Wachstum" />
        </section>
        <section id='webdesigntext4'>
            <img src="/assets/money.webp" alt="Geld" />
            <div><p>
        ...
        <section id='pricing'>
            ...
            <img src="/assets/business.webp" alt="Tinte" />
        </section>
        <section id='endtext'>
