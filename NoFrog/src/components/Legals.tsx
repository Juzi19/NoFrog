...
function Legals() {
  return (
    ...
    <p><strong>NoFrog Webdesign</strong><br />
    Inhaber: Justus Zimmermann<br />
    Tizianstraße 121<br />
    80638, München<br />
    Deutschland</p>

    <h3>Kontakt:</h3>
    <p>Telefon: 0049 1512 6579215<br />
    E-Mail: <a href="mailto:mrfrog@nofrog-webdesign.de">mrfrog@nofrog-webdesign.de</a><br />
    Website: <a href="https:\\www.nofrog-webdesign.de" target="_blank">www.nofrog-webdesign.de</a></p>

    <h3>Umsatzsteuer-ID:</h3>
    <p>Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz: [Deine USt-IdNr.]</p>

    <h3>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h3>
    <p>Justus Zimmermann<br />
    Tizianstraße 121<br />
    80638 München<br />
    Deutschland</p>
